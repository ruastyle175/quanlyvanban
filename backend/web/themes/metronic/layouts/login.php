...
<?php $this->beginBody() ?>
<div class="logo">
    <a href="#"><img src="<?php echo($baseUrl)?>/themes/metronic/assets/pages/img/logo-big.png" alt="" /></a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<?php
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
    <?php echo date('Y', time())?> &copy; <?= $company_name_setting[FConstant::COMPANY_NAME] ?>
</div>
<!-- END COPYRIGHT -->
<script>
