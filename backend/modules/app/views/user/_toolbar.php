...
$bulkActionButton = '<div class="dropdown pull-left" style="margin-left: 3px"><button class="btn btn-default" data-toggle="dropdown">' . Yii::t('common', 'Actions') . '</button>' .
    DropdownX::widget([
        'items' => \yii\helpers\ArrayHelper::merge(
            [FHtml::buildBulkActionsMenu(FHtml::CHANGE_TYPE, Yii::t('common', 'Set') . ' ' . Yii::t('common', 'Type'), 'app_user', 'type')],
            [FHtml::buildBulkActionsMenu(FHtml::CHANGE_TYPE, Yii::t('common', 'Set') . ' ' . Yii::t('common', 'Status'), 'app_user', 'status')],
            [FHtml::buildBulkActionsMenu(FHtml::CHANGE_TYPE, Yii::t('common', 'Set') . ' ' . Yii::t('common', 'Is Online'), 'app_user', 'is_online')],
            [FHtml::buildBulkActionsMenu(FHtml::CHANGE_TYPE, Yii::t('common', 'Set') . ' ' . Yii::t('common', 'Is Active'), 'app_user', 'is_active')],
            ['<li class="divider"></li>'],
