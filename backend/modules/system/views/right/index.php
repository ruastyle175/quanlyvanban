...
/* @var $searchModel backend\modules\system\models\SystemRightSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
/* @var $role_id int */


$role = \backend\modules\system\models\SystemRole::findOne($role_id);

$this->title = 'System Right';

$this->params['breadcrumbs'][] = ['label' => "System Role: " . $role->name, 'url' => ['role/view', 'id' => $role_id]];
