...
return [
    ...
    [
        ...
        'filterInputOptions' => ['placeholder' => Yii::t('VbDen', 'Select Id Donvi Gui')],
        'format' => 'html',
        'hAlign' => 'center',
        'vAlign' => 'middle',
    ...
    [
        ...
        'filterType' => \kartik\grid\GridView::FILTER_SELECT2,
        'filterWidgetOptions' => ['pluginOptions' => ['allowClear' => true]],
        'filterInputOptions' => ['placeholder' => Yii::t('VbDen', 'Select Id Lanh Dao')],
        'format' => 'html',
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'contentOptions' => ['class' => 'col-md-2 nowrap'],
    ...
    //[
        ...
        //'filterType' => \kartik\grid\GridView::FILTER_SELECT2,
        //'filterWidgetOptions' => ['pluginOptions' => ['allowClear' => true]],
        //'filterInputOptions' => ['placeholder' => Yii::t('VbDen', 'Select Id Can Bo')],
        //'format' => 'html',
        //'hAlign' => 'center',
        //'vAlign' => 'middle',
        //'contentOptions' => ['class' => 'col-md-0 nowrap'],
    ...
    //[
        ...
        //'filterType' => \kartik\grid\GridView::FILTER_SELECT2,
        //'filterWidgetOptions' => ['pluginOptions' => ['allowClear' => true]],
        //'filterInputOptions' => ['placeholder' => Yii::t('VbDen', 'Select Id Trang Thai')],
        //'format' => 'html',
        //'hAlign' => 'center',
        //'vAlign' => 'middle',
        //'contentOptions' => ['class' => 'col-md-0 nowrap'],
