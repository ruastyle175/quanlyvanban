<?php
/* @var $user backend\modules\app\models\AppUser */
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;"><tr><td align="center" bgcolor="#eff3f8">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						Hi <?= $user->name ?>, your registration is completed!
					</span></font>
                                        </div>
                                ...
                                <tr><td align="center">
                                        <div style="line-height:24px;">
                                            <a href="<?= Yii::$app->getUrlManager()->getHostInfo().Yii::$app->urlManagerFrontend->createUrl(['index.php/site/confirm-registration', 'email'=>$user->email, 'token'=>$user->password_reset_token]) ?>" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
